...
### 🤖 **Agent Teams - 多 AI 协作平台**

_编排 AI 代理团队，协同处理复杂的多步骤任务_

- **团队管理**
  - 创建支持自定义分配策略的团队（轮询、负载均衡、技能匹配、优先级、随机）
  - 实时团队状态监控和性能分析
  - 可配置的最大成员数和任务路由规则
...
- **Provider 集成**
  - 支持 6+ AI 提供商（Claude、Gemini、Kimi、Qwen、DeepSeek、CCB）
  - 智能模型选择和路由
  - 失败任务的回退策略

<p align="center">
  <img src="./resources/agent-teams-demo.png" alt="Agent Teams 演示" width="800">
</p>

> 💡 **使用场景**：复杂软件开发项目、多步骤研究任务、协作内容创作、带依赖关系的自动化工作流
