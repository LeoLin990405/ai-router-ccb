        ...
        {isSettings ? (
          ...
          <>
            ...
            <div className='mt-10px border-t border-[var(--nexus-border-subtle)] pt-8px flex flex-col gap-4px'>
              ...
              <NexusNavItem label={t('monitor.title', { defaultValue: 'Monitor' })} icon={<LayoutDashboard size={15} />} collapsed={collapsed} active={isMonitor} onClick={() => safeNavigate(isMonitor ? '/guid' : '/monitor')} />
              ...
              <NexusNavItem label={t('agentTeams.title', { defaultValue: 'Agent Teams' })} icon={<LayoutDashboard size={15} />} collapsed={collapsed} active={isAgentTeams} onClick={() => safeNavigate(isAgentTeams ? '/guid' : '/agent-teams/dashboard')} />
            </div>
          </>
        )}
      </div>
